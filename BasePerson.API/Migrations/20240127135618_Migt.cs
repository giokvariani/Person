        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConnectedPeople_Persons_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Phone2People", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Phone2People_Persons_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Phone2People_Phones_PhoneId",
                        column: x => x.PhoneId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Phone2People_PersonId",
                table: "Phone2People",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_Phone2People_PhoneId",
                table: "Phone2People",
                column: "PhoneId");
        }
